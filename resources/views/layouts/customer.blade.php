...
<head>
  ...
  @yield('meta')
  <title>@yield('title', 'Auricular Therapy')</title>
  ...
  <div data-scroll-to-active="true" class="main-menu menu-fixed menu-light menu-accordion menu-shadow">
    <div class="main-menu-content">
      <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
          ...
          <li class="nav-item {{ \Request::is('packages-bought') ? 'active' : '' }}"><a href="{{ route('packages.bought.index') }}"><i class="ft-layers"></i><span data-i18n="" class="menu-title">Packages Bought</span></a>
          </li>

          <li class="nav-item {{ \Request::is('package') || \Request::is('package/*') ? 'active' : '' }}"><a href="{{ route('package.index') }}"><i class="ft-layers"></i><span data-i18n="" class="menu-title">Buy Package</span></a>
          </li>
  ...
  <footer class="footer footer-static footer-dark navbar-border">
    <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2">
      <span class="float-md-left d-xs-block d-md-inline-block">Copyright &copy; 2019, All rights
        reserved. </span>
      <span class="float-md-right d-xs-block d-md-inline-block">Hand-crafted &amp; Made with <i class="ft-heart pink"></i>by : <a href="http://codeburnerz.com">CodeBurnerz Technologies</a></span>
    </p>
  </footer>
  <!-- BEGIN VENDOR JS-->
